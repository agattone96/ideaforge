        ...
        >
          ...
          >
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-sans font-bold text-theme-accent-primary">Send a Message</h2>
              <div className="help-tooltip-wrapper">
                ...
                <span className="help-tooltip-text !text-xs !min-w-[100px] !max-w-[150px] !text-center">Close</span> 
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <TextArea
                ...
                placeholder="Type your query or greeting here..."
                rows={5}
                required
            ...
            <p className="text-xs text-center text-theme-text-secondary mt-6 font-sans">
              We'll do our best to reply quickly.
            </p>
          </motion.div>
        </motion.div>
      )}
