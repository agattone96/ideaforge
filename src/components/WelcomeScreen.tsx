...
export const WelcomeScreenPlaceholder: React.FC = () => (
  <section className="flex flex-col items-center justify-center h-full">
    <h1 className="text-3xl font-bold mb-2">Welcome to IdeaForge</h1>
    <p className="text-lg">Your cosmic forge for ideas.</p>
  </section>
);
